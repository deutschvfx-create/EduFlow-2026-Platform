                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-white/5 hover:bg-transparent">
                            ...
                            <TableHead className="text-[9px] uppercase font-black tracking-widest text-zinc-500 text-center h-10">Avg Score</TableHead>
                            <TableHead className="text-[9px] uppercase font-black tracking-widest text-zinc-500 text-center h-10">Logs</TableHead>
                            <TableHead className="text-[9px] uppercase font-black tracking-widest text-zinc-500 text-right h-10 pr-4">Last Event</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {data.map((row) => (
                            <TableRow key={row.student.id} className="border-white/5 hover:bg-white/[0.02] transition-colors group">
                                ...
                                <TableCell className="py-3 text-center text-zinc-500 text-[10px] font-black">{row.gradesCount}</TableCell>
                                <TableCell className="py-3 text-right text-zinc-600 text-[9px] font-black uppercase pr-4">
                ...
                {data.map((row) => (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-zinc-950/50 p-3 rounded-xl border border-white/5 text-center">
                                <p className="text-[10px] text-zinc-600 font-black uppercase tracking-tighter mb-1">Total Logs</p>
                                <p className="text-lg font-black text-white">{row.gradesCount}</p>
                            </div>
                            <div className="bg-zinc-950/50 p-3 rounded-xl border border-white/5 text-center">
                                <p className="text-[10px] text-zinc-600 font-black uppercase tracking-tighter mb-1">Last Update</p>
