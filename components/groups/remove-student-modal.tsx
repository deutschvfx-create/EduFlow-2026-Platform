...
import { UserMinus, AlertCircle, Loader2 } from "lucide-react";
...
export function RemoveStudentModal({ studentName, groupName, open, onOpenChange, onConfirm }: RemoveStudentModalProps) {
                    ...
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <DialogDescription className="text-[14px] font-medium text-[#64748B] leading-relaxed px-4">
                                Вы собираетесь исключить студента <span className="font-bold text-[#0F172A]">"{studentName}"</span> из группы <span className="font-bold text-[#0F172A]">"{groupName}"</span>.
                            </DialogDescription>
                        </div>

                        <div className="w-full flex items-start gap-3 p-4 bg-slate-50 border border-slate-100 rounded-[20px] text-left mt-2">
                            ...
                            <p className="text-[11px] font-medium text-slate-600 leading-tight">
                                Студент останется в базе данных, но больше не будет числиться в составе этой конкретной группы.
                            </p>
                        </div>
                    </div>
