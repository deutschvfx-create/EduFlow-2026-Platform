...
export function MobileLayout({ children }: MobileLayoutProps) {
    ...
    return (
        <div className="h-[100dvh] w-full bg-background flex flex-col laptop:hidden overflow-hidden selection:bg-primary/30">
            {/* Mobile Header */}
            <MobileHeader />
            ...
            <main className="flex-1 relative overflow-hidden">
                <SwipeableTabs tabs={mainTabs}>
                    <div className="absolute inset-0 overflow-y-auto scroll-smooth overscroll-contain pb-32 custom-scrollbar">
