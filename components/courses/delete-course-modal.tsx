...
export function DeleteCourseModal({ courseName, open, onOpenChange, onConfirm }: DeleteCourseModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[400px] bg-card border-none text-foreground p-0 overflow-hidden rounded-[28px] shadow-2xl">
                <div className="p-8">
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <DialogDescription className="text-[14px] font-medium text-[#64748B] leading-relaxed px-4">
                                Вы собираетесь полностью удалить курс <span className="font-bold text-[#0F172A]">"{courseName}"</span>. Это действие нельзя будет отменить.
                            </DialogDescription>
                        </div>
                        ...
                        <div className="w-full flex items-start gap-3 p-4 bg-red-50 border border-red-100 rounded-[20px] text-left mt-2">
                            ...
                            <p className="text-[12px] font-bold text-red-900 leading-tight">
                                Все связанные данные, материалы и записи о посещаемости будут безвозвратно удалены.
                            </p>
                        </div>
                    </div>
