...
export function UserProfileCard({ onSave }: UserProfileCardProps) {
    ...
    return (
        <Card className="bg-zinc-950/30 border border-zinc-900/50 rounded-xl overflow-hidden mt-6">
                ...
                <div className="flex items-center justify-between px-4 py-3 bg-zinc-900/20 border-b border-zinc-900/50">
                    <div className="flex items-center gap-4 text-sm font-medium text-zinc-400">
                        <button
                            ...
                            className={`flex items-center gap-2 transition-colors ${activeTab === "profile" ? "text-indigo-400 font-bold" : "hover:text-zinc-300"}`}
                        >
                        ...
                        {isOwner && (
                            <button
                                ...
                                className={`flex items-center gap-2 transition-colors ${activeTab === "organization" ? "text-indigo-400 font-bold" : "hover:text-zinc-300"}`}
                            >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 transition-colors ${activeTab === "security" ? "text-indigo-400 font-bold" : "hover:text-zinc-300"}`}
                        >
