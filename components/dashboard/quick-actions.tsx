    ...
    return (
        <div className="space-y-3 laptop:space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-xs laptop:text-sm font-bold uppercase tracking-widest text-muted-foreground">Быстрые действия</h2>
                </div>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 laptop:grid-cols-6 gap-4" data-help-id="dashboard-actions">
                {modules.groups && (
            ...
            {toast && (
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-5">
                    <div className="bg-secondary text-foreground px-4 py-3 rounded-full shadow-2xl border border-border flex items-center gap-4">
